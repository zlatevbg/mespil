...
@section('title', __('No.37, Lisbon real estate investment | Property investment in Lisbon'))
@section('description', __('Invest in No.37, Lisbon, Portugal. Real estate investment opportunity for joint venture partner to co-invest in a fully secured, off market distressed property'))

@section('content')
    {{-- <div id="property-video">
        <div class="container overlay-wrapper overlay-property">
            <div class="property-logo">
                <img loading="eager" src="{{ Helper::autover('/svg/{subdomain}/logo-no-37-lisbon-portugal-inverted.svg') }}" alt="{{ __('Logo: No.37, Lisbon, Portugal') }}" height="124" width="200">
            </div>
        </div>
        <div class="embed-responsive embed-responsive-16by9">
            <video class="embed-responsive-item" autoplay muted playsinline preload="metadata" poster="{{ Helper::autover('/img/{subdomain}/investment-projects/no-37-lisbon-portugal/poster.jpg') }}">
                <source src="/video/no-37-lisbon-portugal.mp4" type="video/mp4"/>
            </video>
        </div>
    </div> --}}
    <div class="property-hero">
        <div class="embed-responsive embed-responsive-16by9 h-100">
            <img loading="eager" class="embed-responsive-item" src="{{ Helper::autover('/img/{subdomain}/investment-projects/no-37-lisbon-portugal/hero.jpg') }}" alt="{{ __('Facade of No.37, Lisbon, Portugal') }}" height="1080" width="1920">
        </div>
        <div class="container overlay-wrapper overlay-property">
            <div class="property-logo">
                <img loading="eager" src="{{ Helper::autover('/svg/{subdomain}/logo-no-37-lisbon-portugal-inverted.svg') }}" alt="{{ __('Logo: No.37, Lisbon, Portugal') }}" height="200" width="124" style="--property-logo-width: 62px; --property-logo-height: 100px">
            </div>
        </div>
    </div>
    ...
    <div class="container container-md-fluid space-single-top">
        <div class="d-flex flex-wrap justify-content-center align-items-center">
            <a class="prev-next-font internal-link d-flex flex-fill justify-content-start align-items-center mr-3" href="{{ Helper::route('investment-project', 'no-24-albufeira-portugal') }}">@fas('long-arrow-alt-left', 'mr-3 fa-2x')<span class="text-nowrap">{{ __('Previous project') }}</span><span class="text-nowrap prev-next-hidden">: {{ __('No.24 Albufeira, Portugal') }}</span></a>
            <a class="prev-next-font internal-link d-flex flex-fill justify-content-end align-items-center ml-3 text-right" href="{{ Helper::route('investment-project', 'evaristo-algarve-portugal') }}"><span class="text-nowrap">{{ __('Next project') }}</span><span class="text-nowrap prev-next-hidden">: {{ __('Evaristo Project, Portugal') }}</span>@fas('long-arrow-alt-right', 'ml-3 fa-2x')</a>
        </div>
    </div>
    ...
    <div class="container space-double space-single-top">
        <div class="row row-cols-1 row-cols-xl-2 mb-n5">
            <div class="col mb-5 position-relative">
                <h1 class="title-border title-border-orange mb-5">{{ __('No.37') }}<br><small class="h3 font-weight-normal">{{ __('Property investment in Lisbon, Portugal') }}</small></h1>
                <p class="project-status status-orange text-white p-2">{{ __('Funding Required') }}</p>
                <p>{{ __('Joint venture partner required to co-invest in a regeneration project in a prime residential area in close proximity to the Tagus river Lisbon, Portugal to our investor club.') }}</p>
                <p>{!! __('MESPIL have purchased this Lisbon development below market value through key relationships bringing to market much in demand real estate to the capital city. This project is also eligible for the lower investment of 350k EURO in Europe’s best :link.', ['link' => '<a class="internal-link" href="' . Helper::route('portugal-golden-visa') . '">' . __('Golden Visa scheme') . '</a>']) !!}</p>
                <div class="bg-light py-3">
                    <ul class="m-0 pr-4">
                        <li>{{ __('9 units, a mix of Studio to T3 apartments and 1 commercial space') }}</li>
                        <li>{{ __('6 month refurbishment program with a 6 month sales program') }}</li>
                        <li>{{ __('Projecting all units sold <3 months') }}</li>
                    </ul>
                </div>
            </div>
            <div class="col mb-5">
                    ...
                    <table class="table table-hover mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-primary font-weight-bold h3 align-middle text-nowrap">{{ __('€ 1 500 000') }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="m-0">{{ __('Estimate all units sold within 3 months.') }}</p>
    ...
    <div class="container space-single">
        <div class="row row-cols-1 row-cols-md-2 mb-n5 photoswipe-wrapper" data-photoswipe-gid="gallery">
            <a class="photoswipe col mb-5" href="{{ Helper::autover('/img/{subdomain}/investment-projects/no-37-lisbon-portugal/gallery/facade.jpg') }}" data-photoswipe-pid="facade" data-photoswipe-size="1920x1080"><img loading="lazy" width="640" height="360" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 360'%3E%3C/svg%3E" data-src="{{ Helper::autover('/img/{subdomain}/investment-projects/no-37-lisbon-portugal/gallery/thumbnails/facade.jpg') }}" class="img-fluid img-thumbnail" alt="{{ __('No.37 Facade') }}"></a>
            <a class="photoswipe col mb-5" href="{{ Helper::autover('/img/{subdomain}/investment-projects/no-37-lisbon-portugal/gallery/25-de-abril-bridge.jpg') }}" data-photoswipe-pid="25-de-abril-bridge" data-photoswipe-size="2560x1438"><img loading="lazy" width="640" height="360" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 360'%3E%3C/svg%3E" data-src="{{ Helper::autover('/img/{subdomain}/investment-projects/no-37-lisbon-portugal/gallery/thumbnails/25-de-abril-bridge.jpg') }}" class="img-fluid img-thumbnail" alt="{{ __('25 de Abril Bridge') }}"></a>
        </div>
    </div>
    ...
    <div class="container space-single">
        <ol class="poi-wrapper list-unstyled mb-0">
            <li><a data-map-type="area" class="poi py-1" href="#project-map"><span class="fa-stack">@fas('circle', 'fa-stack-2x text-primary opacity-10') @far('circle', 'text-primary fa-stack-2x')</span><span>{{ __('No.37 Location') }}</span></a></li>
...
@push('scripts')
    <script>
        ...
        let InfoWindow;
        const markers = [];
        const center = {lat: 38.703960, lng: -9.192360};
